...
const STEPS = [
  ...
  },
  {
    ...
    subtitle: "Days 30–75",
    body: `Credit repair without budget work is like mopping while the faucet's still running.\n\nThis is where you set up your Holding Tank account (a separate savings buffer), build your Bill Ladder, run the 5% Shave on your expenses, and start knocking out debt. You don't have to do all of it perfectly. You just have to start.\n\nThe app tracks your income, your bills, your budget, your debt balances — month by month.\n\nFor expenses that happen multiple times a month — gas, groceries, Amazon runs — add them as Variable expenses. Switch to Bill Ladder view and tap the expense name to log each purchase with a note and date. Your envelope balance updates automatically.`,
